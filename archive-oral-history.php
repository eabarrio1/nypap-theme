 ...
 * @subpackage nypap
 *
 * Template Name: Oral History Listing
 *
 */

get_header(); ?>

<div id="main-content" class="main-content container oral-history-listing">
					...
					if ($terms) {
						foreach ($terms as $term) {
							...
							if (strtolower($term->slug) == "diversity-the-outer-boroughs") { 
								echo '<a class="wp-colorbox-youtube cboxElement" href="https://www.youtube.com/embed/uZrXlLhtBaQ"></a>';
							} 							
